...
p1.3 <- p1.2 + geom_hline(yintercept = c(0.8,0.1))
...
p1.6 <- p1.5 + theme(axis.text=element_text(size=9,color="black"),
             ...
             plot.margin=grid::unit(c(0, 0, 0.5, 0.5), "cm"))
...
p2.3 <- p2.2 + geom_hline(yintercept = c(0.8,0.1))
...
p3.3 <- p3.2 + geom_hline(yintercept = c(0.8,0.1))
...
p4.3 <- p4.2 + geom_hline(yintercept = c(0.8,0.1))
